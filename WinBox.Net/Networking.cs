...
namespace WinBox.Net
{
    public static class Networking
    {
        ...
        public static IEnumerable<IPAddress> GetAllIPAddresses() => GetAdresses(p => p.AnycastAddresses).Select(ToIPAddress)
    ...
    .Distinct();
        ...
        static IPAddress ToIPAddress(IPAddress addr) => addr;
